...
import { EntityInfo, SaveMap, ServerEntityError, EntityStateString } from "./SaveMap";
...
export type BeforeSaveEntityFn = (e: EntityInfo) => boolean;
  ...
  save(): Promise<SequelizeSaveResult> {
    ...
    let entityInfos = this.entitiesFromClient.map(entity => {
      ...
      let ea = {
        ...
        entityState: entityAspect.entityState.name as EntityStateString,
        originalValuesMap: entityAspect.originalValues
      }
      if (!entityType) {
      ...
      let ei: EntityInfo = { entity: entity, entityType: entityType, entityAspect: ea, unmapped: unmapped };
