...
describe("sequelize", function() {
  ...
  it("should save one with autogenerated key", function(done) {
  ...
  it("should save promises with autogenerated key", function(done) {
    var Employee = _nwSm.models.Employee;
    var dtos = createEmpDTOs();
    ...
    // can't use bulkCreate when entities have an autoincremented key because
    // 1) no way to retrieve the key
    // 2) Sequelize won't create the key properly ( bug ??);
    //    Employee.bulkCreate( dtos).then(function(r) {
    //      r.should.have.length(dtos.length);
    //    }).then(done, done);
  });

  it("should be able to bulkCreate with an autogenerated key", function(done) {
    var Employee = _nwSm.models.Employee;
    var dtos = createEmpDTOs();
